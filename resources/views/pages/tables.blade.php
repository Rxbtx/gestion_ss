                        ...
                        <div class="card my-4">
                            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                    <h6 class="text-white text-capitalize ps-3">Actividades</h6>
                                </div>
                            </div>
                            <div class="card-body px-0 pb-2">
                                <div class="table-responsive p-0">
                                    <a href="{{ route('pages.create-activities') }}" class="btn btn-primary">Crear Actividad</a>
                                        ...
                                        <tbody>
                                            @foreach($activities as $activity)
                                                <tr>
                                                    ...
                                                    <td>{{ $activity->fecha_creacion }}</td>
                                                    <td>{{ $activity->fecha_ultima_actualizacion }}</td>
